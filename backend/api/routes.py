...
def generate_poll_config_from_file():
    try:
        ...
        script_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'create_question_config.py')
        ...
        config_path = os.path.join(DATA_DIR, 'question_config.json')
...
def approve_question_route():
    ...
    try:
        ...
        if approved:
            ...
            approved_question_path = os.path.join(DATA_DIR, approved_question_filename)
            survey_results_path = os.path.join(DATA_DIR, survey_results_filename)
            analysis_path = os.path.join(DATA_DIR, analysis_filename)
